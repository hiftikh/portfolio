...
export default function ShraimsSweets() {
  return (
    <>
      ...
      <h3>Logo</h3>
      <Artwork
        imageURL="/img/artwork/work/shraimssweets-logo.jpg"
        alt="Shraim's Sweets Logo"
        caption="Shraim's Sweets Logo"
      />
      <h3>Packaging</h3>
      <Artwork
        imageURL="/img/artwork/work/shraimssweets-box.jpg"
        alt="Shraim's Sweets Box Mockup"
        caption="Box Mockup"
      />

      <Artwork
        imageURL="/img/artwork/work/shraimssweets-bigbox.jpg"
        alt="Shraim's Sweets Big Box Mockup"
        caption="Big Box Mockup"
      />
      <Artwork
        imageURL="/img/artwork/work/shraimssweets-familybox.jpg"
        alt="Shraim's Sweets Family Box Mockup"
        caption="Family Box Mockup"
      />
      <Artwork
        imageURL="/img/artwork/work/shraimssweets-bag.jpg"
        alt="Shraim's Sweets Bag Mockup"
        caption="Bag Mockup"
      />
      <h3>Wallpaper</h3>
      <Artwork
        imageURL="/img/artwork/work/shraimssweets-wall2.png"
        alt="Shraim's Sweets Main Wall"
        caption="Main Wallpaper"
      />
      <Artwork
        imageURL="/img/artwork/work/shraimssweets-wall1.png"
